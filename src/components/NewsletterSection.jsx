...
export default function NewsletterSection() {
  ...
  return (
    <div
      className={`transition duration-500 z- ${
        scrollEffect ? "bg-blue-600" : "bg-stone-100"
      }`}
    >
      <article
        className={`flex flex-col gap-4 bg-stone-100 items-start w-full justify-between xl:px-82 lg:px-32 md:px-12 transition-all duration-700 px-2 pb-48 pt-10 
    `}
      >
